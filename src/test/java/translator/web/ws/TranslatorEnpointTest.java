...
public class TranslatorEnpointTest {
	...
	public void testSendAndReceive() {
		...
		request.setText("I wear red shirt and I like my trousers");
		...
		assertThat(((GetTranslationResponse) response).getTranslation(), is("Me pongo rojo de la camisa y me gusta que mis pantalones"));
	}	
}
